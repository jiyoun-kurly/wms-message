...
@Getter
public class MdOrderDocumentDto {
    ...
    private ArrayList<MdOrderDocumentDto> orderInfoList;
	...
	public void setOrderInfoList(ArrayList<MdOrderDocumentDto> orderInfoList) {
